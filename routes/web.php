...
Route::middleware(['auth'])
    ->group(function () {
        ...
        Route::controller(LeechMovieController::class)->group(function () {
            ...
            Route::get('watch-leech-detail/{slug}', 'watch_leech_detail')->name('watch_leech_detail');
            Route::get('watch-leech-detail-episode/{slug}', 'watch_leech_detail_episode')->name('watch_leech_detail');
