                ...
                $.getJSON('/json/movies.json',(data) => {
                    $.each(data,(key,value) => {
                        ...
                        if(value.title.search(expression) != -1  ){
                            $('#result').append('<li class="list-group-item" style="cursor:pointer"><image height="40" width="40" src="/uploads/movie/'+ value.image +'" />'+ value.title + '<br/> | <span>' + value.description +'</span></li>')
                        }
                    })
                })
            }else{
