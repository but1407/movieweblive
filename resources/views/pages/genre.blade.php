...
@section('content')
    <div class="row container" id="wrapper">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-6">
                    <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{ $genre_slug->name_eng }}</a> » <span class="breadcrumb_last" aria-current="page">2020</span></span></span></div>
                </div>
            </div>
        </div>
        ...
        <section>
            <div class="section-bar clearfix">
                <h1 class="section-title"><span>{{ $genre_slug->name_eng }}</span></h1>
            </div>
            <div class="halim_box">
                @if (isset($movies))
                    ...
                    @foreach ($movies as $movie )
                        ...
                        <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-27021">
                            ...
                            <a class="halim-thumb" href="{{ route('movie.show',$movie->slug) }}" title="{{ $movie->title }}">
