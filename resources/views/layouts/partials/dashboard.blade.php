...
@section('content')
        ...
        <div id="page-wrapper">
            <div class="main-page">
                ...
                <!-- for amcharts js -->
                <script src="{{ asset('backends/admin/js/amcharts.js') }}"></script>
                <script src="{{ asset('backends/admin/js/serial.js') }}"></script>
                <script src="{{ asset('backends/admin/js/export.min.js') }}"></script>
                <link rel="stylesheet" href="{{ asset('backends/admin/css/export.css') }}" type="text/css"
                    media="all" />
                <script src="{{ asset('backends/admin/js/light.js') }}"></script>
                <!-- for amcharts js -->
                <script src="{{ asset('backends/admin/js/index1.js') }}"></script>
                <div class="charts">
